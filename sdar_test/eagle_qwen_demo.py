...
--------
  ...
  Draft  : yuhuili/EAGLE-Qwen2.5-7B-Instruct
...
Step 1: 在另一个终端启动服务器
  ...
  python -m sglang.launch_server \\
      ...
      --speculative-draft-model-path yuhuili/EAGLE-Qwen2.5-7B-Instruct \\
...
DEFAULT_DRAFT_MODEL = "yuhuili/EAGLE-Qwen2.5-7B-Instruct"
